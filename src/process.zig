...
pub const Process = struct {
    ...
    pub fn resume_p(self: *const Self) !void {
    ...
    pub fn wait_on_signal(self: *const Self) u32 {
    ...
    pub fn wait_until_exit(self: *const Self) !u8 {
    ...
    pub fn wait_until_stop(self: *const Self) !u32 {
    ...
    pub fn kill(self: *const Self, signal: std.posix.SIG) !void {
